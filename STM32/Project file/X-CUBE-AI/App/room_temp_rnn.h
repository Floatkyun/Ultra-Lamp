/**
  ...
  ******************************************************************************
  */
#ifndef AI_ROOM_TEMP_RNN_H
#define AI_ROOM_TEMP_RNN_H

#include "room_temp_rnn_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_ROOM_TEMP_RNN_MODEL_NAME          "room_temp_rnn"
#define AI_ROOM_TEMP_RNN_ORIGIN_MODEL_NAME   "room_temp_lstm"

/******************************************************************************/
#define AI_ROOM_TEMP_RNN_ACTIVATIONS_ALIGNMENT   (4)
#define AI_ROOM_TEMP_RNN_INPUTS_IN_ACTIVATIONS   (4)
#define AI_ROOM_TEMP_RNN_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_ROOM_TEMP_RNN_IN_NUM        (1)

AI_DEPRECATED
#define AI_ROOM_TEMP_RNN_IN \
  ai_room_temp_rnn_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_ROOM_TEMP_RNN_IN_SIZE { \
  AI_ROOM_TEMP_RNN_IN_1_SIZE, \
}
#define AI_ROOM_TEMP_RNN_IN_SIZE_BYTES { \
  AI_ROOM_TEMP_RNN_IN_1_SIZE_BYTES, \
}
#define AI_ROOM_TEMP_RNN_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_ROOM_TEMP_RNN_IN_1_HEIGHT      (6)
#define AI_ROOM_TEMP_RNN_IN_1_CHANNEL     (1)
#define AI_ROOM_TEMP_RNN_IN_1_SIZE        (6)
#define AI_ROOM_TEMP_RNN_IN_1_SIZE_BYTES  (24)

/******************************************************************************/
#define AI_ROOM_TEMP_RNN_OUT_NUM       (1)

AI_DEPRECATED
#define AI_ROOM_TEMP_RNN_OUT \
  ai_room_temp_rnn_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_ROOM_TEMP_RNN_OUT_SIZE { \
  AI_ROOM_TEMP_RNN_OUT_1_SIZE, \
}
#define AI_ROOM_TEMP_RNN_OUT_SIZE_BYTES { \
  AI_ROOM_TEMP_RNN_OUT_1_SIZE_BYTES, \
}
#define AI_ROOM_TEMP_RNN_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_ROOM_TEMP_RNN_OUT_1_CHANNEL     (1)
#define AI_ROOM_TEMP_RNN_OUT_1_SIZE        (1)
#define AI_ROOM_TEMP_RNN_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_ROOM_TEMP_RNN_N_NODES (3)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup room_temp_rnn
 ...
 * @ref ai_room_temp_rnn_create. Both the activations memory buffer 
 ...
 * using @ref ai_room_temp_rnn_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_room_temp_rnn_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_room_temp_rnn_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_ROOM_TEMP_RNN_*
 * defines into file @ref room_temp_rnn.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_room_temp_rnn_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_ROOM_TEMP_RNN_H */
