...
{
	HAL_RTC_GetTime(&hrtc,&wtime,RTC_FORMAT_BIN);
	screen_work_digital_clock_min_value = wtime.Minutes;
	screen_work_digital_clock_hour_value = wtime.Hours;
	screen_work_digital_clock_sec_value = wtime.Seconds;
