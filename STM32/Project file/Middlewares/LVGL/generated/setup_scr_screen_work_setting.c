...
void setup_scr_screen_work_setting(lv_ui *ui)
{
	...
	screen_work_setting_digital_clock_min_value = stime.Minutes;
	screen_work_setting_digital_clock_hour_value = stime.Hours;
	screen_work_setting_digital_clock_sec_value = stime.Seconds;
